...
export function Landing({ onNavigate }: LandingProps) {
  return (
    <div className="min-h-screen bg-crema text-crust font-sans">
      ...
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center overflow-hidden bg-crust bg-texture">
        <div
        ...
        <div className="relative z-20 text-center px-4 pt-16 mt-8 max-w-4xl mx-auto flex flex-col items-center">
          <span className="text-terracota tracking-widest uppercase text-sm font-semibold mb-4 drop-shadow-md">
            Lista la Focaccia
          </span>
          ...
          <button
            ...
            className="group relative px-8 py-4 bg-oliva text-crema font-bold uppercase tracking-widest rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.2)] hover:bg-oliva/90 hover:-translate-y-1 active:scale-95 transition-all duration-300"
          >
      ...
      {/* Nosotros Section */}
      <section id="nosotros" className="py-24 px-4 bg-crema relative bg-texture">
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <span className="text-terracota tracking-widest uppercase text-sm font-semibold mb-4 block">
                Nuestra Historia
              </span>
              <h3 className="text-4xl md:text-5xl text-crust font-display font-bold mb-6">
                Tradición en cada masa
              </h3>
              <div className="w-20 h-1 bg-terracota mb-6 rounded-full" />
              <p className="text-crust text-lg leading-relaxed mb-6">
              ...
              <p className="text-crust text-lg leading-relaxed">
      ...
      <section id="contacto" className="py-24 px-4 bg-crust text-crema">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="w-24 h-1 bg-terracota mx-auto mb-8 rounded-full" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 border-2 bg-texture border-crema/50 text-crema hover:bg-crema hover:text-crust font-bold rounded-full transition-all flex items-center gap-3"
            >
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">

...
export function CartDrawer() {
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="bg-crema border-l border-terracota/20 w-full sm:max-w-md flex flex-col">
        {!showCheckout ? (
          <>
            <SheetHeader>
              ...
              {items.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-display text-carbon font-medium truncate">
                      {item.focaccia.name}
                    </h4>
            ...
            {/* Footer */}
            <div className="border-t border-terracota/10 pt-4 space-y-4">
              <div className="flex justify-between items-center">
                <span className="text-carbon/70">Subtotal</span>
                <span className="font-display text-xl text-carbon">
              ...
              <Button
                ...
                className="w-full bg-terracota hover:bg-terracota/90 text-crema font-medium h-12 rounded-xl"
              >
                Continuar
